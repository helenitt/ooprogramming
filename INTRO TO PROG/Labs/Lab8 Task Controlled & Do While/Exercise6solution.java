 ...
 *is used for the iteration process and a switch for the menu selection process. This version
 *contains some basic input validation code for the choice and the Celcius temperature*/
