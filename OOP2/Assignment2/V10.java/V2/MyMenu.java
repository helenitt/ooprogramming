...
public class MyMenu extends JFrame implements ActionListener {
    ...
    public void takeTest() {
	        ...
	        testId++;
			Test t = new Test(testId, name, score);                                               //HERE
			...
			FileOutputStream fos = new FileOutputStream(fin);
			ObjectOutputStream oos = new ObjectOutputStream(fos);//Now save the updated array list of tests to a file for future retrieval
