...
public class MyMenu extends JFrame implements ActionListener {
	...
	JLabel response;
	JTextArea textArea;
	//JButton submitButton;  READY TO APPEAR IN JTEXTAREA FOR TEST AFTER OR WITH Q's 
	...
	public MyMenu() {
		...
		//READY FOR WHEN THE JRADIOBUTTONS ARE USED ON THE TEXTAREA
		//The submit button will appear with or after the third question
    ...
    public void takeTest() {
	        ...
	        String corAns;
	        int ranNum, score = 0, testId = 0;
	        
	        display(); // Need this to load questions
