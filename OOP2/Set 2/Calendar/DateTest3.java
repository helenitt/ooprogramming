...
public class DateTest3 {
   public static void main( String args[] ) {
      GregorianCalendar today,birthday; // capture today's date
      today = new GregorianCalendar();  // set up the date of your birthday: nb year, month, day: and month counts from 0
      birthday = new GregorianCalendar(1986,06,04);
      
      SimpleDateFormat f3 = new SimpleDateFormat("EEEE MMMM dd'th', yyyy");
      
      JOptionPane.showMessageDialog(null, "Today is " + f3.format(today.getTime()) );
      JOptionPane.showMessageDialog(null, "My birthday is " + f3.format(birthday.getTime()) );
