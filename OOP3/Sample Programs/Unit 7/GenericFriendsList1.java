...
public class GenericFriendsList1 {
    public static void main(String[] arg) {
		...
		//ListIterator
		output.setText("Here's the result of using a listIterator\n" );
		ListIterator<Person> it=friends.listIterator();
		while(it.hasNext()) output.append(it.next().getName()+"\n");
		JOptionPane.showMessageDialog(null,output);

		output.setText("Here's the result of using an Iterator\n" );
		Iterator<Person> it1=friends.iterator();
		while(it1.hasNext()) output.append(it1.next().getName()+"\n");
		JOptionPane.showMessageDialog(null,output);
